...
class BuddiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buddy" do
    assert_difference('Buddy.count') do
      post buddies_url, params: { buddy: { adoptable: @buddy.adoptable, age: @buddy.age, color: @buddy.color, name: @buddy.name, species: @buddy.species } }
    end
  ...
  test "should update buddy" do
    patch buddy_url(@buddy), params: { buddy: { adoptable: @buddy.adoptable, age: @buddy.age, color: @buddy.color, name: @buddy.name, species: @buddy.species } }
